...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Users -c jdbc:mysql://localhost:3306/cc7 -ne admin@example.com -np admin -nu admin -p cc7 -u cc7
...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Create -a cc7 -p admin -u admin -jn 127.0.0.1:1099
...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Settings -c jdbc:mysql://localhost:3306/cc7 -p admin -u admin -path /var/cc7/
...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Search -b http://localhost/cc7 -p admin -u admin -c start
...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Scheduling  -b http://localhost/cc7 -p admin -u admin -c start
...
bc. java -cp shell-tools-7.1.7-jar-with-dependencies.jar ccc.cli.Schema -c jdbc:mysql://localhost:3306/cc7 -p admin -u admin -v 1
