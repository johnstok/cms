...
create table file_revisions (id varchar(36) not null, vn bigint not null, size_in_bytes integer not null, data_id varchar(36) not null, mime_type_primary varchar(255) not null, mime_type_sub varchar(255) not null, major_change bit not null, actor_comment varchar(1024), timestamp datetime not null, actor_id varchar(36) not null, file_id varchar(36) not null, revision_no integer, primary key (id)) ENGINE=InnoDB;
...
create table page_revision_paragraphs (page_revision_id varchar(36) not null, name varchar(255) not null, type varchar(255) not null, value_text longtext, value_boolean bit, value_date datetime, primary key (page_revision_id, name, type)) ENGINE=InnoDB;
create table page_revisions (id varchar(36) not null, vn bigint not null, major_change bit not null, actor_comment varchar(1024), timestamp datetime not null, actor_id varchar(36) not null, page_id varchar(36) not null, revision_no integer, primary key (id)) ENGINE=InnoDB;
...
create table page_wcopy_paragraphs (page_wcopy_id varchar(36) not null, name varchar(255) not null, type varchar(255) not null, value_text longtext, value_boolean bit, value_date datetime, primary key (page_wcopy_id, name, type)) ENGINE=InnoDB;
...
create table template_revisions (id varchar(36) not null, vn bigint not null, body longtext not null, definition longtext not null, mime_type_primary varchar(255) not null, mime_type_sub varchar(255) not null, major_change bit not null, actor_comment varchar(1024), timestamp datetime not null, actor_id varchar(36) not null, template_id varchar(36) not null, revision_no integer, primary key (id)) ENGINE=InnoDB;
