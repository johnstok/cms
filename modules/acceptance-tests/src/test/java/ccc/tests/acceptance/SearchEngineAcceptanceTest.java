...
public class SearchEngineAcceptanceTest
    ...
    public void testFindPageById() {
        ...
        // ACT
        final SearchResult result =
            getSearch().find("id:\""+page.getId()+"\" AND type:page", 10, 0);
    ...
    public void testFindFileById() {
        ...
        // ACT
        final SearchResult result =
            getSearch().find("id:\""+res.getId()+"\" AND type:file", 10, 0);
    ...
    public void testFindAliasesFindsNothing() {
        ...
        // ACT
        final SearchResult result =
            getSearch().find("type:alias", 10, 0);
    ...
    public void testFindFileByContent() {
        ...
        // ACT
        final SearchResult result =
            getSearch().find(content+" AND type:file", 10, 0);
    ...
    public void testSearchFindsSecureResourcesForGroup() {
        ...
        // ACT
        final SearchResult result = getSearch().find(searchTerm, 10, 0);
