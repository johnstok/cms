...
<h2 id="Commonusage">Velocity examples (7.2)</h2>
...
<span class="whitespace">&nbsp; &nbsp; &nbsp; &nbsp;</span><span class="xml-text">#if ($para.getName() == $name </span><span class="xml-entity">&amp;&amp; $para.getText())</span><br />
<span class="whitespace">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span><span class="xml-text">$startText</span><br />
<span class="whitespace">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</span><span class="xml-text">$para.getText()</span><br />
...
<p>Normal $resource.getParagraph(&quot;NAME&quot;).getText() causes an exception in case there is no paragraph with matching name.</p>
