...
public class FCKEditor extends LayoutContainer {
    ...
    private static native String initJSNI(final FCKEditor obj) /*-{
        $wnd.cccLinkSelector = function(fckname, url, title, innerText, cccId, openInNew) {
            obj.@ccc.contentcreator.widgets.FCKEditor::openLinkSelector(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)(fckname,url,title,innerText,cccId,openInNew);
        };

        $wnd.cccImageSelector = function(fckname, url, alt, title, cccId) {
            obj.@ccc.contentcreator.widgets.FCKEditor::openImageSelector(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)(fckname,url,alt,title,cccId);
        };
    }-*/;
