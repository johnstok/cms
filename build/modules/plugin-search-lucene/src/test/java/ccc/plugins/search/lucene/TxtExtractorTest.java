...
/**
 * Tests for the {@link TxtExtractor} class.
 *
 * @author Civic Computing Ltd.
 */
public class TxtExtractorTest
    extends
        TestCase {
    ...
    public void testHandlesZeroLengthInput() {
        ...
        // ACT
        te.execute(new ByteArrayInputStream(new byte[] {}));
     ...
     */
    public void testHandlesGoodInput() throws Exception {
