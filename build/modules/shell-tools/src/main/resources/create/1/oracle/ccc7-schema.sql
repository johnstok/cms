...
create table file_revisions (id varchar2(36 char) not null, vn number(19,0) not null, size_in_bytes number(10,0) not null, data_id varchar2(36 char) not null, mime_type_primary varchar2(255 char) not null, mime_type_sub varchar2(255 char) not null, major_change number(1,0) not null, actor_comment varchar2(1024 char), timestamp timestamp not null, actor_id varchar2(36 char) not null, file_id varchar2(36 char) not null, revision_no number(10,0), primary key (id));
...
create table page_revision_paragraphs (page_revision_id varchar2(36 char) not null, name varchar2(255 char) not null, type varchar2(255 char) not null, value_text clob, value_boolean number(1,0), value_date timestamp, primary key (page_revision_id, name, type));
create table page_revisions (id varchar2(36 char) not null, vn number(19,0) not null, major_change number(1,0) not null, actor_comment varchar2(1024 char), timestamp timestamp not null, actor_id varchar2(36 char) not null, page_id varchar2(36 char) not null, revision_no number(10,0), primary key (id));
...
create table page_wcopy_paragraphs (page_wcopy_id varchar2(36 char) not null, name varchar2(255 char) not null, type varchar2(255 char) not null, value_text clob, value_boolean number(1,0), value_date timestamp, primary key (page_wcopy_id, name, type));
...
create table template_revisions (id varchar2(36 char) not null, vn number(19,0) not null, body clob not null, definition clob not null, mime_type_primary varchar2(255 char) not null, mime_type_sub varchar2(255 char) not null, major_change number(1,0) not null, actor_comment varchar2(1024 char), timestamp timestamp not null, actor_id varchar2(36 char) not null, template_id varchar2(36 char) not null, revision_no number(10,0), primary key (id));
