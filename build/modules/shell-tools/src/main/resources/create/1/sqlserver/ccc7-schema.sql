...
create table file_revisions (id varchar(36) not null, vn numeric(19,0) not null, size_in_bytes int not null, data_id varchar(36) not null, mime_type_primary varchar(255) not null, mime_type_sub varchar(255) not null, major_change tinyint not null, actor_comment varchar(1024) null, timestamp datetime not null, actor_id varchar(36) not null, file_id varchar(36) not null, revision_no int null, primary key (id));
...
create table page_revision_paragraphs (page_revision_id varchar(36) not null, name varchar(255) not null, type varchar(255) not null, value_text text null, value_boolean tinyint null, value_date datetime null, primary key (page_revision_id, name, type));
create table page_revisions (id varchar(36) not null, vn numeric(19,0) not null, major_change tinyint not null, actor_comment varchar(1024) null, timestamp datetime not null, actor_id varchar(36) not null, page_id varchar(36) not null, revision_no int null, primary key (id));
create table page_wcopies (id varchar(36) not null, vn numeric(19,0) not null, page_id varchar(36) not null, primary key (id));
create table page_wcopy_paragraphs (page_wcopy_id varchar(36) not null, name varchar(255) not null, type varchar(255) not null, value_text text null, value_boolean tinyint null, value_date datetime null, primary key (page_wcopy_id, name, type));
...
create table template_revisions (id varchar(36) not null, vn numeric(19,0) not null, body text not null, definition text not null, mime_type_primary varchar(255) not null, mime_type_sub varchar(255) not null, major_change tinyint not null, actor_comment varchar(1024) null, timestamp datetime not null, actor_id varchar(36) not null, template_id varchar(36) not null, revision_no int null, primary key (id));
